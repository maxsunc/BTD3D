...
public enum TowerType {
	DART_MONKEY("Dart Monkey", 170,32,0.95f,50, TowerClass.PRIMARY),
	SNIPER_MONKEY("Sniper Monkey", 300,1600,1.59f,100, TowerClass.MILITARY),
	BOMB_TOWER("Bomb Shooter", 445 ,40,1.5f,25, TowerClass.PRIMARY),
	SUPER_MONKEY("Super Monkey", 2125,50,0.045f,50, TowerClass.PRIMARY);
